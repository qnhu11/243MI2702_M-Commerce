...
public class ProductDetailActivity extends AppCompatActivity {
    ...
    private void addViews() {
        ...
        edt_product_img_id=findViewById(R.id.edt_product_img_id);
        display_infor();
    }
    ...
    private void display_infor() {
        ...
        edt_cate_id.setText(p.getCate_id()+"");
        edt_product_description.setText(p.getDescription()+"");
        edt_product_img_id.setText(p.getImage_id()+"");
    }
}